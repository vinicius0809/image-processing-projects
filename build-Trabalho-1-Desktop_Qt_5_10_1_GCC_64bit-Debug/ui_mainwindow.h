...
public:
    ...
    QAction *actionMinimo;
    QAction *actionMaximo;
    QAction *actionGaussiano;
    QAction *actionEqualiza_o_de_HistogramaHSV;
    QAction *actionFiltro_MedianaHSV;
    QAction *actionFiltro_GaussianoHSV;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionMediana->setObjectName(QStringLiteral("actionMediana"));
        actionMinimo = new QAction(MainWindow);
        actionMinimo->setObjectName(QStringLiteral("actionMinimo"));
        actionMaximo = new QAction(MainWindow);
        actionMaximo->setObjectName(QStringLiteral("actionMaximo"));
        actionGaussiano = new QAction(MainWindow);
        actionGaussiano->setObjectName(QStringLiteral("actionGaussiano"));
        actionEqualiza_o_de_HistogramaHSV = new QAction(MainWindow);
        actionEqualiza_o_de_HistogramaHSV->setObjectName(QStringLiteral("actionEqualiza_o_de_HistogramaHSV"));
        actionFiltro_MedianaHSV = new QAction(MainWindow);
        actionFiltro_MedianaHSV->setObjectName(QStringLiteral("actionFiltro_MedianaHSV"));
        actionFiltro_GaussianoHSV = new QAction(MainWindow);
        actionFiltro_GaussianoHSV->setObjectName(QStringLiteral("actionFiltro_GaussianoHSV"));
        ...
        menuFiltros_2->addAction(actionMediana);
        menuFiltros_2->addAction(actionMinimo);
        menuFiltros_2->addAction(actionMaximo);
        menuFiltros_2->addAction(actionGaussiano);
        menuImagem_colorida->addAction(actionBrilho);
        menuImagem_colorida->addAction(actionEqualiza_o_de_HistogramaHSV);
        menuImagem_colorida->addAction(actionFiltro_MedianaHSV);
        menuImagem_colorida->addAction(actionFiltro_GaussianoHSV);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actionMediana->setText(QApplication::translate("MainWindow", "Mediana", nullptr));
        actionMinimo->setText(QApplication::translate("MainWindow", "Minimo", nullptr));
        actionMaximo->setText(QApplication::translate("MainWindow", "Maximo", nullptr));
        actionGaussiano->setText(QApplication::translate("MainWindow", "Gaussiano", nullptr));
        actionEqualiza_o_de_HistogramaHSV->setText(QApplication::translate("MainWindow", "Equaliza\303\247ao de Histograma", nullptr));
        actionFiltro_MedianaHSV->setText(QApplication::translate("MainWindow", "Filtro Mediana", nullptr));
        actionFiltro_GaussianoHSV->setText(QApplication::translate("MainWindow", "Filtro Gaussiano", nullptr));
